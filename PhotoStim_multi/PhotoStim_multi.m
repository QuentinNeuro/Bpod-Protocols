...
TrialTypes = repmat(trial_block, 1, (MaxTrials-1)/length(trial_block));
...
for currentTrial = 1:MaxTrials-1
    switch TrialTypes(currentTrial) % Determine trial-specific state matrix fields
        case 1
            %load('/home/kepecslab/Documents/MATLAB/Bpod_0_5/Protocols/PhotoStim_multi/LightTrain_10Hz_5ms');
            load('LightTrain_10Hz_5ms');
        case 2
            %load('/home/kepecslab/Documents/MATLAB/Bpod_0_5/Protocols/PhotoStim_multi/LightTrain_20Hz_5ms');
            load('LightTrain_20Hz_5ms');
        case 3
            %load('/home/kepecslab/Documents/MATLAB/Bpod_0_5/Protocols/PhotoStim_multi/LightTrain_40Hz_5ms');
            load('LightTrain_40Hz_5ms');
        case 4
            %load('/home/kepecslab/Documents/MATLAB/Bpod_0_5/Protocols/PhotoStim_multi/LightTrain_80Hz_5ms');
            load('LightTrain_80Hz_5ms');
    end
...
OutcomePlot_PhotoStim_multi(BpodSystem.GUIHandles.OutcomePlot,'update',Data.nTrials,2-TrialTypes,Outcomes)
