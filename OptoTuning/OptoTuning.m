...
S.PulsePalProtocol={'Train_10Hz_500ms_5ms_5V','Pulse_500ms_5V'};%,'Pulse_5ms_5V','Pulse_10ms_5V'}; %{'Pulse_3ms_5V','Pulse_5ms_5V','Pulse_10ms_5V'};
S.TrialsNames=S.PulsePalProtocol;
BNCpp=ParamPC.BPPP_BNC;
for i=1:size(S.TrialsNames,2)
    thisPP=S.PulsePalProtocol{i};
    pm{i}=load(thisPP);
end
...
%% Assemble State matrix
    ...
    sma = AddState(sma, 'Name','PreStim',...
        'Timer',S.GUI.TimePreStim,...
        'StateChangeConditions',{'Tup','StimDelivery'},...
        'OutputActions',{'BNCState',1});
    %Cue Delivery
    sma=AddState(sma,'Name', 'StimDelivery',...
        'Timer',S.GUI.TimeStim,...
        'StateChangeConditions',{'Tup', 'PostStim'},...
        'OutputActions', {'BNCState',BNCpp});
    %Post Cue Delivery
    sma=AddState(sma,'Name', 'PostStim',...
        'Timer',S.GUI.TimePostStim,...
